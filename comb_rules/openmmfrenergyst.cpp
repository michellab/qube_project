...
CMMremoval_frequency(0), buffer_frequency(0), energy_frequency(100), device_index("0"), precision("single"), Alchemical_value(0.0), coulomb_power(0),
...
void OpenMMFrEnergyST::initialise()
{
    ...
    if (combiningRules == "arithmetic")
    {
        ...
        printf("@@@@@@@@@@@@ THE COMB RULES FLAG IS ARITHMETIC\n");
    }
    else if (combiningRules == "geometric")
    {
        flag_combRules = GEOMETRIC;
        printf("@@@@@@@@@@@@ THE COMB RULES FLAG IS GEOMETRIC\n");
    }
    else
     ...
     if (flag_cutoff == NOCUTOFF)
    {
        ...
        { //This is necessary to avoid nan errors on the GPUs platform caused by the calculation of 0^0
            ...
            std::string energybase = """(1.0 - isSolvent1 * isSolvent2 * SPOnOff) * (Hcs + Hls);"
                    ...
                    if (flag_combRules == ARITHMETIC)
                    {
                        ...
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF\n");
                    }
                    else if (flag_combRules == GEOMETRIC)
                    {
                        ...
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF\n");
                    }
            ...
            std::string intra_14_todummy = """Hcs + Hls;"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_todummy.append("sigma_avg = (1-lamtd)*saend + lamtd*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF- intra_14_todummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_todummy.append("sigma_avg = sqrt((1-lamtd)*(1-lamtd)*saend + lamtd*lamtd*sastart + lamtd*(1-lamtd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF- intra_14_todummy\n");
                    }
            ...
            std::string intra_14_fromdummy = """Hcs + Hls;"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_fromdummy.append("sigma_avg = lamfd*saend + (1-lamfd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF- intra_14_FROMdummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_fromdummy.append("sigma_avg = sqrt(lamfd*lamfd*saend + (1-lamfd)*(1-lamfd)*sastart + lamfd*(1-lamfd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF- intra_14_FROMdummy\n");
                    }
            ...
            std::string intra_14_fromdummy_todummy = """Hcs + Hls;"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_fromdummy_todummy.append("sigma_avg = lamftd*saend + (1-lamftd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF- intra_14_FROMDUMMYtodummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_fromdummy_todummy.append("sigma_avg = sqrt(lamftd*lamftd*saend + (1-lamftd)*(1-lamftd)*sastart + lamftd*(1-lamftd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF- intra_14_FROMDUMMYtodummy\n");
                    }
        ...
        {// coulomb_power == 0. //This is necessary to avoid nan errors on the GPUs platform caused by the calculation of 0^0
            ...
            std::string energybase ="""(1.0 - isSolvent1 * isSolvent2 * SPOnOff) * (Hcs + Hls);"
                    ...
                    {
                        energybase.append("sigma_avg = 0.5*((sigmaend1*lam+(1.0-lam)*sigmastart1)+(sigmaend2*lam+(1.0-lam)*sigmastart2));");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF COIL POWER = 0\n");
                    }
                    else if (flag_combRules == GEOMETRIC)
                    {
                        energybase.append("sigma_avg = sqrt((sigmaend1*lam+(1.0-lam)*sigmastart1)*(sigmaend2*lam+(1.0-lam)*sigmastart2));");
                        //energybase.append("sigma_avg = 0.5*((sigmaend1*lam+(1.0-lam)*sigmastart1)+(sigmaend2*lam+(1.0-lam)*sigmastart2));");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF COIL POWER = 0\n");
                    }
            ...
            std::string intra_14_todummy = """Hcs + Hls;"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_todummy.append("sigma_avg = (1-lamtd)*saend + lamtd*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_todummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_todummy.append("sigma_avg = sqrt((1-lamtd)*(1-lamtd)*saend + lamtd*lamtd*sastart + lamtd*(1-lamtd)*samix);");
                        //intra_14_todummy.append("sigma_avg = (1-lamtd)*saend + lamtd*sastart;");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_todummy:\n");
                    }
            ...
            std::string intra_14_fromdummy = """Hcs + Hls;"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_fromdummy.append("sigma_avg = lamfd*saend + (1-lamfd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_FROMdummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_fromdummy.append("sigma_avg = sqrt(lamfd*lamfd*saend + (1-lamfd)*(1-lamfd)*sastart + lamfd*(1-lamfd)*samix);");
                        //intra_14_fromdummy.append("sigma_avg = lamfd*saend + (1-lamfd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_FROMdummy\n");
                    }
            ...
            std::string intra_14_fromdummy_todummy = """Hcs + Hls;"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_fromdummy_todummy.append("sigma_avg = lamftd*saend + (1-lamftd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_FROMDUMMYtodummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        //intra_14_fromdummy_todummy.append("sigma_avg = lamftd*saend + (1-lamftd)*sastart;");
                        intra_14_fromdummy_todummy.append("sigma_avg = sqrt(lamftd*lamftd*saend + (1-lamftd)*(1-lamftd)*sastart + lamftd*(1-lamftd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_FROMDUMMYtodummy\n");
                    }
        ...
        std::string intra_14_clj = """Hl+Hc;"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_clj.append("sigma_avg = lamhd*saend + (1-lamhd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_CLJ\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        //intra_14_clj.append("sigma_avg = lamhd*saend + (1-lamhd)*sastart;");
                        intra_14_clj.append("sigma_avg = sqrt(lamhd*lamhd*saend + (1-lamhd)*(1-lamhd)*sastart + lamhd*(1-lamhd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH NO CUTOFF COIL POWER = 0 - intra_14_CLJ\n");
                    }
    ...
    {//CUTOFF PERIODIC OR NON PERIODIC
        ...
        {//This is necessary to avoid nan errors on the GPUs platform caused by the calculation of 0^0
            ...
            std::string energybase = """(1.0 - isSolvent1 * isSolvent2 * SPOnOff) * (Hls + Hcs);"
                    ...
                    {
                        energybase.append("sigma_avg = 0.5*((sigmaend1*lam+(1.0-lam)*sigmastart1)+(sigmaend2*lam+(1.0-lam)*sigmastart2));");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH CUTOFF COUL POWER > 0 \n");
                    }
                    else if (flag_combRules == GEOMETRIC)
                    {
                        energybase.append("sigma_avg = sqrt((sigmaend1*lam+(1.0-lam)*sigmastart1)*(sigmaend2*lam+(1.0-lam)*sigmastart2));");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH CUTOFF COUL POWER > 0 \n");
                    }
            ...
            std::string intra_14_todummy = """withinCutoff*(Hcs + Hls);"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_todummy.append("sigma_avg = (1-lamtd)*saend + lamtd*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH CUTOFF COUL POWER > 0 - intra_14_todummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_todummy.append("sigma_avg = sqrt((1-lamtd)*(1-lamtd)*saend + lamtd*lamtd*sastart + lamtd*(1-lamtd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH CUTOFF COUL POWER > 0 intra_14_todummy\n");
                    }
            ...
            std::string intra_14_fromdummy = """withinCutoff*(Hcs + Hls);"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_fromdummy.append("sigma_avg = lamfd*saend + (1-lamfd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH CUTOFF COUL POWER > 0 - intra_14_FROMdummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_fromdummy.append("sigma_avg = sqrt(lamfd*lamfd*saend + (1-lamfd)*(1-lamfd)*sastart + lamfd*(1-lamfd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH CUTOFF COUL POWER > 0 - intra_14_FROMdummy\n");
                    }
            ...
            std::string intra_14_fromdummy_todummy = """withinCutoff*(Hcs + Hls);"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_fromdummy_todummy.append("sigma_avg = lamftd*saend + (1-lamftd)*sastart;");
                        printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH CUTOFF COUL POWER > 0 - intra_14_FROMDUMMYtodummy\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_fromdummy_todummy.append("sigma_avg = sqrt(lamftd*lamftd*saend + (1-lamftd)*(1-lamftd)*sastart + lamftd*(1-lamftd)*samix);");
                        printf("@@@@@@@@ THESE ARE THE GEOMETRIC COMB RULES WITH CUTOFF COUL POWER > 0 - intra_14_FROMDUMMYtodummy\n");
                    }
        ...
        std::string intra_14_clj = """withinCutoff*(Hl+Hc);"
                ...
                if (flag_combRules == ARITHMETIC)
                    {
                        intra_14_clj.append("sigma_avg = lamhd*saend + (1-lamhd)*sastart;");
                         printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH CUTOFF COUL POWER = 0 - intra_14_CLJ\n");
                    }
                else if (flag_combRules == GEOMETRIC)
                    {
                        intra_14_clj.append("sigma_avg = sqrt(lamhd*lamhd*saend + (1-lamhd)*(1-lamhd)*sastart + lamhd*(1-lamhd)*samix);");
                         printf("@@@@@@@@ THESE ARE THE ARITHMETIC COMB RULES WITH CUTOFF COUL POWER = 0 - intra_14_CLJy\n");
                    }
    ...
    //             int par_atom1 = AtomNumToOpenMMIndex[atom1]; 
    //             int par_atom2 = AtomNumToOpenMMIndex[atom2]; 
    //             int par_atom3 = AtomNumToOpenMMIndex[atom3]; 

    //             if (Debug)
    //                 {
    //                     qDebug() << "HERE ARE THE VSITES: atom1 " << atom1 << " pos1 " << pos1 << " wx1 " << wx1 << " wy1 " << wy1;
    //                 }
    //             //int openmm_vs_index = vsIndex + 1; 
    ...
    //             if (Debug)
    //                 {
    //                     qDebug() << " positions" << positions << " o_weights " << o_weights << " x_weights " << x_weights << " y_weights " << y_weights << "parent atoms" << parent_atoms;
    //                 }
    //             //system_index  = system_index +1;
   ...
   // bool hasVirtualSites = molecule.hasProperty("virtual-sites");
    ...
    //             std::vector<double> vs_custom_non_bonded_params(10);

    //             vs_custom_non_bonded_params[0] = -0.18000; //charge_start
    //             vs_custom_non_bonded_params[1] = 0.00000; //charge_end
    //             vs_custom_non_bonded_params[2] = 0.00000 * OpenMM::KJPerKcal; //epsilon_start
    //             vs_custom_non_bonded_params[3] = 0.00000 * OpenMM::KJPerKcal; //epsilon_end
    //             vs_custom_non_bonded_params[4] = 1.00000 * OpenMM::NmPerAngstrom; //sigma_start
    //             vs_custom_non_bonded_params[5] = 0.00000 * OpenMM::NmPerAngstrom; //sigma_end
    //             vs_custom_non_bonded_params[6] = 1.0; //isHard
    //             vs_custom_non_bonded_params[7] = 0.0; //isTodummy
    //             vs_custom_non_bonded_params[8] = 0.0; //isFromdummy
    //             vs_custom_non_bonded_params[9] = 0.0; //isSolventProtein
    //             //nonbond_openmm->addParticle(vs_custom_non_bonded_params[0], vs_custom_non_bonded_params[4],  vs_custom_non_bonded_params[2]);
                
    //              custom_force_field->addParticle(vs_custom_non_bonded_params);
                

    //              if (Debug)
    //             {
    //                 qDebug() << "Charge start = " << vs_custom_non_bonded_params[0];
    //                 qDebug() << "Charge end = " << vs_custom_non_bonded_params[1];
    //                 qDebug() << "Eps start = " << vs_custom_non_bonded_params[2];
    //                 qDebug() << "Eps end = " << vs_custom_non_bonded_params[3];
    //                 qDebug() << "Sig start = " << vs_custom_non_bonded_params[4];
    //                 qDebug() << "Sig end = " << vs_custom_non_bonded_params[5];
    //                 qDebug() << "is Hard = " << vs_custom_non_bonded_params[6];
    //                 qDebug() << "is To dummy = " << vs_custom_non_bonded_params[7];
    //                 qDebug() << "is From dummy = " << vs_custom_non_bonded_params[8];
    //                 qDebug() << "is Solvent = " << vs_custom_non_bonded_params[9] << "\n";
    //             }
    //         }
    //     } 
    ...
    //         //     bondPairs.push_back(std::make_pair(system_index, idx1));
    //         // else if (idx1 == parent_index)
    //         //     bondPairs.push_back(std::make_pair(system_index, idx0));
    //         // else
    //         //     {}
    //         // }
    ...
    //     }
        ...
        // if (Debug)
        //     qDebug() <<"@@@@GET ALL ANGLES: "<< amber_params.getAllAngles();
        ...
        // if (Debug)
        //     qDebug() <<"@@@@GET ALL DIHEDRALS: "<< amber_params.getAllDihedrals();
     ...
     // if (hasVirtualSites)
     //     {
     //        QPair<int, int> vspair(11, 9);
     //        QPair<double, double> ljpair(0.5, 0.5);
     //        custom14pairs.insert(vspair, ljpair);
     //        special_14 = true;

     //        QPair<int, int> vspair1(11, 1);
     //        QPair<double, double> ljpair1(0.5, 0.5);
     //        custom14pairs.insert(vspair1, ljpair1);
     //        special_14 = true;

     //        QPair<int, int> vspair2(11, 5);
     //        QPair<double, double> ljpair2(0.5, 0.5);
     //        custom14pairs.insert(vspair2, ljpair2);
     //        special_14 = true;

     //        QPair<int, int> vspair3(11, 8);
     //        QPair<double, double> ljpair3(0.5, 0.5);
     //        custom14pairs.insert(vspair3, ljpair3);
     //        special_14 = true;
    ...
    // if (hasVirtualSites )
    // {
    //  nonbond_openmm->createExceptionsFromBonds(bondPairs, 0.5, 0.5);   
    // }
    // else
    // {
    ...
    for (int i = 0; i < num_exceptions; i++)
    {
        ...
        {//1-4 interactions
            ...
            if (flag_combRules == ARITHMETIC)
                {
                    ...
                    printf("HERE WE SET THE SIGMA WITH THE ARITHMETIC COMB RULES \n");

                }
            else if (flag_combRules == GEOMETRIC)
                {
                    
                    sigma_avg_start = Sigstart_p1 * Sigstart_p2 * LennardJones14Scale_tmp * LennardJones14Scale_tmp;
                    sigma_avg_end = Sigend_p1 * Sigend_p2 * LennardJones14Scale_tmp * LennardJones14Scale_tmp;
                    sigma_avg_mix = (Sigend_p1 * Sigstart_p2 + Sigstart_p1 * Sigend_p2)* LennardJones14Scale_tmp * LennardJones14Scale_tmp;
                    
                    printf("HERE WE SET THE SIGMA WITH THE GEOMETRIC COMB RULES \n");
                }
            ...
            if ((isHard_p1 == 1.0 && isHard_p2 == 1.0))
            {
                ...
                if (Debug)
                    qDebug() << "Added clj Hard 1-4 to "<< p1 <<"and " << p2;
            }
    ...
    if (Debug)
    {
        qDebug() << "Num particles  = " << custom_force_field->getNumParticles();
...
void OpenMMFrEnergyST::createContext(IntegratorWorkspace &workspace, SireUnits::Dimension::Time timestep)
{
    ...
    if (Debug)
    {
        ...
        qDebug() << " Is Context Initialised?: "<< isContextInitialised;
        qDebug() << " Reinitialise Context: "<< reinitialise_context;
    }
   ...
   // bool hasVirtualSites = molecule.hasProperty("virtual-sites");
    ...
    // if (system_index + nvirtualsites != nats)
    // {
    //     if (Debug)
...
MolarEnergy OpenMMFrEnergyST::getPotentialEnergy(const System &system)
{
    ...
    qDebug() << " @@@@ stete openmm potential energy (molar energy):  " << state_openmm.getPotentialEnergy()<< "kJ/mol";
